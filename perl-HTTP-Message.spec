%{?scl:%scl_package perl-HTTP-Message}

Name:           %{?scl_prefix}perl-HTTP-Message
Version:        6.18
Release:        8%{?dist}
...
BuildRequires:  %{?scl_prefix}perl(Encode) >= 2.21
BuildRequires:  %{?scl_prefix}perl(Encode::Locale) >= 1
BuildRequires:  %{?scl_prefix}perl(Exporter) >= 5.57
BuildRequires:  %{?scl_prefix}perl(HTTP::Date) >= 6
BuildRequires:  %{?scl_prefix}perl(IO::Compress::Bzip2) >= 2.021
BuildRequires:  %{?scl_prefix}perl(IO::Compress::Deflate)
BuildRequires:  %{?scl_prefix}perl(IO::Compress::Gzip)
BuildRequires:  %{?scl_prefix}perl(IO::HTML)
BuildRequires:  %{?scl_prefix}perl(IO::Uncompress::Bunzip2) >= 2.021
BuildRequires:  %{?scl_prefix}perl(IO::Uncompress::Gunzip)
BuildRequires:  %{?scl_prefix}perl(IO::Uncompress::Inflate)
BuildRequires:  %{?scl_prefix}perl(IO::Uncompress::RawInflate)
BuildRequires:  %{?scl_prefix}perl(LWP::MediaTypes) >= 6
BuildRequires:  %{?scl_prefix}perl(MIME::Base64) >= 2.1
...
Requires:       %{?scl_prefix}perl(Encode) >= 2.21
Requires:       %{?scl_prefix}perl(Encode::Locale) >= 1
Requires:       %{?scl_prefix}perl(HTTP::Date) >= 6
Requires:       %{?scl_prefix}perl(IO::Compress::Bzip2) >= 2.021
Requires:       %{?scl_prefix}perl(IO::Compress::Deflate)
Requires:       %{?scl_prefix}perl(IO::Compress::Gzip)
Requires:       %{?scl_prefix}perl(IO::HTML)
Requires:       %{?scl_prefix}perl(IO::Uncompress::Bunzip2) >= 2.021
Requires:       %{?scl_prefix}perl(IO::Uncompress::Gunzip)
Requires:       %{?scl_prefix}perl(IO::Uncompress::Inflate)
Requires:       %{?scl_prefix}perl(IO::Uncompress::RawInflate)
Requires:       %{?scl_prefix}perl(LWP::MediaTypes) >= 6
Requires:       %{?scl_prefix}perl(MIME::Base64) >= 2.1
...
%global __requires_exclude %{?__requires_exclude:%__requires_exclude|}^%{?scl_prefix}perl\\((Exporter|HTTP::Date|URI)\\)$
%global __provides_exclude %{?__provides_exclude:%__provides_exclude|}^%{?scl_prefix}perl\\(HTTP::Headers\\)$
...
%changelog
* Thu Feb 13 2020 Petr Pisar <ppisar@redhat.com> - 6.18-8
- Import to SCL
